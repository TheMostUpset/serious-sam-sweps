local function SS_SettingsPanel(Panel)
	...
	Panel:AddControl("CheckBox", {Label = "Static Crosshair", Command = "ss_crosshair_static"})
	Panel:AddControl("Slider", {Label = "Crosshair Style", Command = "ss_crosshair", Type = "Integer", Min = 0, Max = 7})
	Panel:AddControl("Slider", {Label = "Crosshair Scale", Command = "ss_crosshair_scale", Type = "Float", Min = 1, Max = 5})
